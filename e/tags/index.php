...
//require(ECMS_PATH.'e/extend/ecmscache/MakeCache.php');
//if(!intval(getcvar('mlgroupid'))) exit('服务器压力过大，暂时关闭游客访问，待机房扩容后开放。请谅解。');
$mgroupid = intval(getcvar('mlgroupid'));
$link=db_connect();
...
if(!$mgroupid){
	...
	$listpage='<font size=4 color=#f66>因伺服器壓力過大，遊客訪問暫只顯示最近25條信息，請<a href="/e/member/login/">【登陸】</a>瀏覽更多，或待機房擴容後開放，工程師會持續優化負載，請見諒</font>';
}else {
