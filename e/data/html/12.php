...
</td></tr><tr><td height=25 colspan=2 bgcolor='ffffff'><div align=left>套图正文</div></td></tr></table><div style='background-color:#D0D0D0'><?=ECMS_ShowEditorVar("newstext",$ecmsfirstpost==1?"":stripSlashes($r[newstext]),"Default","","300","100%")?>
    ...
    <td bgcolor="#FFFFFF"><input name="repimgnexturl" type="checkbox" id="repimgnexturl" value="1"> 图片链接转为下一页&nbsp;&nbsp; <input name="autopage" type="checkbox" id="autopage" value="1"> 自动分页
      ...
      *高
      <input name="getfirsttitlespich" type="text" id="getfirsttitlespich" size="3" value="<?=$public_r[spicheight]?>">
        ...
        </table></div><table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'><tr><td width='16%' height=25 bgcolor='ffffff'>下载地址</td><td bgcolor='ffffff'>
<script>
function doadd()
{var i;
var str="";
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>网盘密码</td><td bgcolor='ffffff'><input name="pan_s" type="text" id="pan_s" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[pan_s]))?>" size="60">
</td></tr></table>