...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>日文标题</td><td bgcolor='ffffff'><input name="jptitle" type="text" id="jptitle" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[jptitle]))?>" size="60">
