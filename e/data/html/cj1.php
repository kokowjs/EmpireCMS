...
?>  <tr bgcolor="#FFFFFF"> 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>相片数(阿拉伯数字)正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--pic_num--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_pic_num]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_pic_num]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_pic_num]" type="text" id="add[z_pic_num]" value="<?=stripSlashes($r[z_pic_num])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
