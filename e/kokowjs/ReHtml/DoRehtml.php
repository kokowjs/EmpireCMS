...
echo"<link href='../adminstyle/".$loginadminstyleid."/adminstyle.css' rel='stylesheet' type='text/css'><center>要刷新的表的总个数为:<font color=red>$count</font>个.当前生成ID" .$_COOKIE['currentId']. "</center><br>";
for($i=0;$i<$count;$i++)
{
