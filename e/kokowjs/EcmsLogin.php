...
//if($_POST['writer']=='咻咻羞' or $_POST['writer']=='花开彼岸' or $_POST['writer']=='RUA' or $_POST['writer']=='交通鬼刀') exit(mb_convert_encoding('标题重复:', "UTF-8", "GBK").$m_title);
echo '111';
/****以下代码非专业人员不建议修改***************/
...
if(!$_POST['newstext'] or !preg_match('/<img/', $_POST['newstext'])) exit(mb_convert_encoding('内容为空:', "UTF-8", "GBK").$loginin);

/*
if (!preg_match("/<img/", $_POST['newstext'])) {
    //不允许特殊字符
    exit(mb_convert_encoding('内容为空:', "UTF-8", "GBK").$loginin);
}
*/
//验证用户
