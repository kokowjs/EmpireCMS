...
require(ECMS_PATH.'e/template/incfile/header_noloading.php');
?>
...
<form name="add" method="POST" enctype="multipart/form-data" action="ecms.php" onsubmit="return EmpireCMSQInfoPostFun(document.add,'<?=$mid?>');">
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
          <tr class="header"> 
            <td height="25" colspan="2"> 
              <button type="button" class="btn btn-secondary btn-lg btn-block"><?=$word?></button>
  ...
  @include($modfile);
  ?>
									<div class="table-data__tool-right" style="text-align:center">
									<?=$showkey?>
                                        <input type="submit" name="addnews" value="提交" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                                            <input type="reset" name="Submit2" value="重置" class="au-btn au-btn-icon au-btn--green au-btn--small">
